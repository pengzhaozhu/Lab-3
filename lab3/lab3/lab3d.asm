...
ldi r22, 0x12               ;load low byte of 0x7A12
sts TCC0_PER, r22          ;transfer to TCC0_PER
ldi r22, 0x7A              ;load high byte of 0x7A12
sts TCC0_PER+1, r22         ;transfer to TCC0_PER+1
ldi r22, 0b00000111       ;prescaler CLK/1024
sts TCC0_CTRLA, r22       ;CTRLA controls the count (CNT)
...
FLAG:
lds r23, TCC0_INTFLAGS     ;check if the flag is set
bst r23, 0                 ;check the zero bite
brtc FLAG                ;if not set, branch to return
ldi r23, 0x01            ;to clear the flag
sts TCC0_INTFLAGS, r23   ;clears the flag
...
brne FLAG         ; otherwise, branch to load
